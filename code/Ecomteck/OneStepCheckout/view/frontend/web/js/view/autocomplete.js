        ...
        return Component.extend({
            ...
            initialize: function () {
                if (window.checkoutConfig.onestepcheckout.autoComplete.enabled) {
                    async.load(
                        'https://maps.googleapis.com/maps/api/js?key=' + window.checkoutConfig.onestepcheckout.autoComplete.apiKey + '&libraries=places&callback=initAutocomplete&language=ar',
                        requirejs,
                        function () {
