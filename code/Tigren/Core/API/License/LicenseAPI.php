...
namespace Tigren\Core\API\License;

/**
 * Class \Tigren\Core\API\License\LicenseAPI
 */
class LicenseAPI {

    const SECURE_KEY = 'e7c057dd1b4b48b33fbb7a209a985401';
    const SIGN_KEY   = '313bedf16ab4808add9654c1c65ccf60';
    ...
    protected function getLicenseFilePath()
    {
        ...
        return $licenseDir . DIRECTORY_SEPARATOR . 'apj-license';
    }
    ...
    protected function registerLicense($serverSign, $serverData)
    {
        ...
        $result = @file_get_contents('https://license.tigren.in/api/sign/', false, $context);
