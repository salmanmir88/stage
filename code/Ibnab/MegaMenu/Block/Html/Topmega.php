...
class Topmega extends Topmenu {
    ...
    \Magento\Framework\Data\Tree\Node $menuTree, $childrenWrapClass, $limit, array $colBrakes = []
    ) {
        $html = '';
        ...
        foreach ($children as $child) {
            ...
            //the above is original logic below we changed to add links to all categories
            if (1==1) {
