    ...
    public function getCollection()
    {
        ...
        foreach ($data as $key => $item) {
            if (isset($compareData[$key]) && $compareData[$key] > 0) {
                $tenthPart = $item['count']/10;
                $item['count'] =  round($item['count'] - $tenthPart);
                $tenthPartC = $compareData[$key]['count']/10;
                $compareData[$key]['count'] =  round($compareData[$key]['count'] - $tenthPartC);
