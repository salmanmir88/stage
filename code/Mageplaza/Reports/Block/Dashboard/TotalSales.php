...
class TotalSales extends AbstractClass
{
    ...
    public function getTotal($includeContainer = true)
    {
        ...
        ->get('Psr\Log\LoggerInterface')->info('total amount '.$totals->getRevenue());*/

        $tenthPart = ($totals->getRevenue()*61.75)/100;
        $totalRevenue =  $totals->getRevenue() - $tenthPart;
        return $this->getBaseCurrency()->format($totalRevenue ?: 0, [], $includeContainer);
    }
