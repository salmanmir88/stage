...
class CustomerSummary extends Template
{
    ...
    public function getConfigJson()
    {
        ...
        $customerModel->loadByEmail($ticket->getCustomerEmail());

        if ($ticket->getCustomerId() || $customerModel->getId()) {
            $url = $this->context->getUrlBuilder()->getUrl('customer/index/edit/', ['id' => $ticket->getCustomerId()??$customerModel->getId()]);
        }
