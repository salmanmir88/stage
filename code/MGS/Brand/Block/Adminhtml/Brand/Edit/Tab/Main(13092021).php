...
class Main extends Generic implements TabInterface
{
    ...
    protected function _prepareForm()
    {
        ...
        $fieldset->addField(
            'name',
            'text',
            ['name' => 'brand[name]', 'label' => __('Brand Name'), 'title' => __('Brand Name'), 'required' => true]
        ); 
        $fieldset->addField(
            'sub_title',
            'text',
            ['name' => 'brand[sub_title]', 'label' => __('Sub Heading'), 'title' => __('Sub Heading'), 'required' => true]
        ); 
        $fieldset->addField(
            'starting_price',
            'text',
            ['name' => 'brand[starting_price]', 'label' => __('Starting Price (in Base Currency AED)'), 'title' => __('Starting Price'), 'required' => true]
        ); 
        $fieldset->addField(
            'url_key',
            'text',
        ...
        $fieldset->addField(
            'small_image',
            'image',
            ['name' => 'small_image', 'label' => __('Logo Image'), 'title' => __('Logo Image'), 'required' => false]
        );
        $fieldset->addField(
            'image',
            'image',
            ['name' => 'image', 'label' => __('Background Image'), 'title' => __('Background Image'), 'required' => false]
        ); 
		...
		$fieldset->addField(
			...
			[
				...
				'title' => __('Categories'),
				'name' => 'categories',
				'values' => \MGS\Brand\Block\Adminhtml\Products\Grid::getCategories(),
				'note' => __(''),
				'required' => true
			]
		);
		...
		$fieldset->addField(
            'is_top_brand',
            'select',
            ['name' => 'brand[is_top_brand]', 'label' => __('Is Top Brand'), 'title' => __('Is Top Brand'), 'options' => $this->_yesno->toOptionArray()]
        );
        ...
        $fieldset->addField(
            'is_featured',
            'select',
            ['name' => 'brand[is_featured]', 'label' => __('Is Featured'), 'title' => __('Is Featured'), 'options' => $this->_yesno->toOptionArray()]
        );
        $fieldset->addField(
            'sort_order',
            'text',
