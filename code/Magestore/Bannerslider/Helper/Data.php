...
class Data extends \Magento\Framework\App\Helper\AbstractHelper
{
    ...
    public function getSliderModeAvailable()
    {
        return [
            ...
            Slider::STYLESLIDE_ADVSLIDER => 'ADS Slider 1 ',
            Slider::STYLESLIDE_ADVSLIDER_ONE => 'ADS Slider 2 ',
        ];
    }
        ...
        return [
            ...
            [
                ...
                'value' => [
                    ...
                    [
                        'label' => __(' ADS Slider 1'),
                        'value' => Slider::STYLESLIDE_ADVSLIDER,
                    ],
                    [
                        'label' => __('ADs Slider 2'),
                        'value' => Slider::STYLESLIDE_ADVSLIDER_ONE,
                    ],
                ],
            ],
        ];
