...
class Save extends \Magestore\Bannerslider\Controller\Adminhtml\Banner
{
    ...
    public function execute()
    {
        ...
        if ($data = $this->getRequest()->getPostValue()) {
            ...
            $imageRequest = $this->getRequest()->getFiles('thumbnail_image');
            if ($imageRequest) {
                if (isset($imageRequest['name'])) {
                    $fileName = $imageRequest['name'];
                } else {
            ...
            if ($imageRequest && strlen($fileName)) {
                 ...
                 */
                try {
                    $uploader = $this->_uploaderFactory->create(['fileId' => 'thumbnail_image']);
                    ...
                    $data['thumbnail_image'] = \Magestore\Bannerslider\Model\Banner::BASE_MEDIA_PATH.$result['file'];
                } catch (\Exception $e) {
                    if ($e->getCode() == 0) {
                        $this->messageManager->addError($e->getMessage());
                    }
                ...
                if (isset($data['thumbnail_image']) && isset($data['thumbnail_image']['value'])) {
                    if (isset($data['thumbnail_image']['delete'])) {
                        $data['thumbnail_image'] = null;
                        $data['delete_image'] = true;
                    } elseif (isset($data['thumbnail_image']['value'])) {
