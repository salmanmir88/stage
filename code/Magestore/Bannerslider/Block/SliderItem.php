...
class SliderItem extends \Magento\Framework\View\Element\Template
{
    ...
    public function getThumbnailImageUrl(\Magestore\Bannerslider\Model\Banner $banner)
    {
        return $this->_bannersliderHelper->getBaseUrlMedia($banner->getThumbnailImage());
    }
