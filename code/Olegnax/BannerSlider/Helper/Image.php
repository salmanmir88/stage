...
class Image extends AbstractHelper
{
    ...
    {
        if (($this->getWidth() === null && $this->getHeight() === null) || !$this->getBaseFile()) {
            return $this;
        }
    ...
    private function getResizedFile()
    {
        ...
        if (is_array($new_filename) && !empty($new_filename)) {
            $new_filename['filename'] = implode('_', [
    ...
    public function removeResized($file)
    {
        ...
        if (!empty($file)) {
            ...
            $new_filename['filename'] = implode('_',
                    [$new_filename['filename'], '*']) . '.' . $new_filename['extension'];
            $pattern = implode('/',
                [$this->getDestinationSubdir(), $new_filename['dirname'], $new_filename['filename']]);
