...
use Olegnax\BannerSlider\Controller\Adminhtml\Slides;

class NewAction extends Slides {
	...
	Context $context, Registry $coreRegistry, ForwardFactory $resultForwardFactory
	) {
