...
namespace Evince\ShipmentOrderStatus\Setup;
use Exception;
...
class InstallData implements InstallDataInterface
{
     ...
     */
    const ORDER_STATUS_PROCESSING_FULFILLMENT_CODE = 'shipment';
    /**
     * Custom Processing Order-Status label
     */
    const ORDER_STATUS_PROCESSING_FULFILLMENT_LABEL = 'Ready to Delivery';
    /**
     ...
     */
    const ORDER_STATUS_CUSTOM_CODE = 'shipment';
    /**
     * Custom Order-Status label
     */
    const ORDER_STATUS_CUSTOM_LABEL = 'Ready to Delivery';
    /**
     * Status Factory
     *
     * @var StatusFactory
