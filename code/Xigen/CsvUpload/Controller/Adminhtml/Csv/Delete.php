...
class Delete extends \Xigen\CsvUpload\Controller\Adminhtml\Csv
{
    ...
    public function execute()
    {
        ...
        if($lockToApplyId === $id || $applyId === $id || $isLockedToRemove === $id){
            $this->messageManager->addErrorMessage('Cannot delete, this file is already applied or in process to apply or remove rule !');
